...
for line in f:    #Ip address called from the file#
    ...
    HOST = line.strip()    #Telnet to hosts in devicesips# #strip used to delete all white spaces#
...
#next script opens file(Switch+IP) and saves the running-configs to it#
    ...
    saveoutput = open("ConfigsFor" + HOST, "w")    #here I need the variable to read/write, hence w# #make sure the file name contians NO spaces#
